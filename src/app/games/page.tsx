    ...
    <div className="container mx-auto px-4 py-8 overflow-y-auto">
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        <p className="text-gray-600 mb-4">
          ...
          <span className="font-semibold text-indigo-600">{userScore.score} punti</span> in classifica.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Link href="/games/screebai" className="block">
          <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:scale-105">
            ...
            <div className="p-4">
              ...
              <p className="text-gray-600 text-sm">Disegna la parola indicata e fai indovinare all&apos;AI cosa hai disegnato.</p>
            </div>
          </div>
        </Link>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden opacity-70">
          ...
          <div className="p-4">
            ...
            <p className="text-gray-600 text-sm">In arrivo presto! Indovina la parola dalle immagini generate dall&apos;AI.</p>
            <span className="inline-block mt-2 px-2 py-1 text-xs bg-yellow-100 text-yellow-800 rounded">In arrivo</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden opacity-70">
          ...
          <div className="p-4">
            ...
            <p className="text-gray-600 text-sm">In arrivo presto! Metti alla prova la tua conoscenza con domande generate dall&apos;AI.</p>
            <span className="inline-block mt-2 px-2 py-1 text-xs bg-yellow-100 text-yellow-800 rounded">In arrivo</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden opacity-70">
          ...
          <div className="p-4">
            ...
            <p className="text-gray-600 text-sm">In arrivo presto! Crea storie e contenuti seguendo i suggerimenti dell&apos;AI.</p>
            <span className="inline-block mt-2 px-2 py-1 text-xs bg-yellow-100 text-yellow-800 rounded">In arrivo</span>
          </div>
        </div>
      </div>
